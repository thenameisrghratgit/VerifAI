...
/* The card matches the design: white, rounded-2xl, shadow */
...
export default function Login({ onLogin, onGoToSignup }) {
  ...
  return (
    <div style={{ display: 'flex', height: '100%', overflow: 'hidden' }}>
      ...
      {/* ── Right panel — form left-aligned, space on right ── */}
      <Right>
        <Card>
          <h2>Welcome back</h2>
          <p className="subtitle">Sign in to your VerifAI account to continue.</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <SignInWrap>
              <input id="si-toggle" className="si-cbox" type="checkbox" />
          ...
          <P>Don&apos;t have an account?<button className="link" onClick={onGoToSignup}>Sign Up</button></P>
